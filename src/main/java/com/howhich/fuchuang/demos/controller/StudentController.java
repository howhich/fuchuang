...
import com.howhich.fuchuang.demos.entity.req.StudentSelfEditReqVO;
...
//    }
    ...
    public Result<GetStudentInfoRespVO> getStudentInfo(){
        return authService.getStudentSelfInfo();
    }

    @SaCheckRole(value = RoleType.STUDENT.code)
    @PostMapping("/studentEdit")
    @ApiOperation(value = "学生编辑自身信息")
    public Result edit(@RequestBody StudentSelfEditReqVO reqVO){
        return authService.studentSelfEdit(reqVO);
    }
